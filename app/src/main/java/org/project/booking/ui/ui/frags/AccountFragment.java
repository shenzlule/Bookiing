...
import org.project.booking.ui.AuthSignInActivity;
...
public class AccountFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        logoutButton = view.findViewById(com.example.booking.R.id.btn_logout);
    ...
    private void logoutUser() {
        ...
        googleSignInClient.signOut().addOnCompleteListener(getActivity(), task -> {
            googleSignInClient.revokeAccess().addOnCompleteListener(getActivity(), task1 -> {
                ...
                Intent intent = new Intent(getActivity(), AuthSignInActivity.class);
