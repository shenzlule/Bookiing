...
import org.project.booking.ui.ui.frags.InfoFragment;
import org.project.booking.ui.ui.frags.BookingsFragment;
import org.project.booking.ui.ui.frags.AccountFragment;
import org.project.booking.ui.ui.frags.HostelsFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.booking.R.layout.activity_tabs_main);
        ...
        AccountFragment fragmentProfile = new AccountFragment();
        BookingsFragment fragmentmy = new BookingsFragment();
        HostelsFragment fragmenttimeline = new HostelsFragment();
        InfoFragment fragmentAbout = new InfoFragment();
        ...
        viewPager = findViewById(R.id.viewpager);
            ...
            adapter.addFragment(fragmenttimeline, "Hostel");
            adapter.addFragment(fragmentmy, "Bookings");
            adapter.addFragment(fragmentProfile, "My Account");
            adapter.addFragment(fragmentAbout, "Info");
...
//                }
                ...
                if (fragment instanceof BookingsFragment) {
                    ((BookingsFragment) fragment).refresh();  // Call the refresh method to reload data
                }

                if (fragment instanceof HostelsFragment) {
                    ((HostelsFragment) fragment).refresh();  // Call the refresh method to reload data
                }
